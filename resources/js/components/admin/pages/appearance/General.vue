        ...
        <v-card-title>
            <div class="page__title">
                <v-icon color="primary" x-large
                    >$vuetify.icons.application-cog</v-icon
                >
                {{ $t("General") }}
            </div>
            ...
            <v-row>
                ...
                <v-col cols="12" sm="6">
                    <veutify-select
                        ...
                        :messages="
                            $t(
                                'Select the landing page of your platform. You can create custom pages.'
                            )
                        "
                        outlined
                    ></veutify-select>
                ...
                <v-col cols="12" sm="6">
                    <v-switch
                        :label="$t('Hide Right-sidebar')"
                        v-model="$store.getters.getSettings.hideRightSidebar"
                    ></v-switch>
                </v-col>
            </v-row>
            <v-row>
                ...
                <v-col cols="6">
                    <image-picker
                        ...
                        :src="appFavicon.base64 || appFavicon"
...
export default {
    ...
    data() {
        return {
            ...
            appLogoDefault: "/images/favicon/logo.png",
            appFaviconDefault: "/images/favicon/icon-192x192.png",
