            ...
            <v-row>
                ...
                <v-col cols="12">
                    <v-switch
                        ...
                        :label="$t('User Upload')"
                        :messages="
                            $t('Allow users to upload audio files locally.')
                        "
                    ></v-switch>
                </v-col>
                <v-col cols="12">
                        ...
                        <v-row>
                            ...
                            <template v-if="settings.enable_artist_account">
                                <v-col>
                                    <v-switch
                                        v-model="
                                            settings.allowArtistAccountRequests
                                        "
                                        :label="
                                            $t('Allow artist account requests')
                                        "
                                        :messages="
                                            $t(
                                ...
                                <v-col
                                    cols="12"
                                    v-if="settings.saas && settings.royalties"
                                >
                    ...
                    <v-row>
                        <v-col cols="12">
                            <v-textarea
                                ...
                                :messages="
                                    $t(
                                        'The message that shows below the registration form'
                                    )
                                "
