            ...
            <v-list-item-group color="primary">
                <template v-for="(item, i) in items">
                    ...
                    >
                        <v-list-item-icon>
                            <v-icon
                                v-text="'$vuetify.icons.' + item.icon"
                            ></v-icon>
                        </v-list-item-icon>
                        <v-list-item-content>
                            <v-list-item-title
                    ...
                    >
                        ...
                        >
                            <v-list-item-icon>
                                <v-icon
                                    v-text="'$vuetify.icons.' + sub_item.icon"
                                ></v-icon>
                            </v-list-item-icon>
                            <v-list-item-content>
                                <v-list-item-title
    ...
    created() {
        ...
        this.items = this.items.filter((item) => {
            if (
                ...
                return this.hasPermission("Read artists") &&
                    this.$store.getters.getSettings.enable_artist_account
                    ? 1
                    : 0;
            } else if (
                item.name === "podcasts" ||
                ...
                (item.children &&
                    item.children.find((item) => item.name === "subscriptions"))
            ) {
                return this.hasPermission("CED subscriptions") &&
                ...
                return this.hasPermission("Edit advertisements") &&
                    this.$store.getters.getSettings.saas
                    ? 1
                    : 0;
            } else if (
                ...
                (item.children &&
                    item.children.find((item) => item.name === "translations"))
            ) {
                return this.hasPermission("CED translations") ? 1 : 0;
            } else if (
                item.name === "sales" ||
                (item.children &&
                    item.children.find((item) => item.name === "sales"))
            ) {
                return this.hasPermission("View sales") &&
                    this.$store.getters.getSettings.saas
                    ? 1
                    : 0;
            } else if (item.name === "monetizing") {
                return this.$store.getters.getSettings.saas ? 1 : 0;
            } else if (
                item.name === "payouts" ||
                (item.children &&
                    item.children.find((item) => item.name === "payouts"))
            ) {
                return this.hasPermission("View payouts") &&
                    this.$store.getters.getSettings.saas
                    ? 1
                    : 0;
            } else if (
                item.name === "contact" ||
                (item.children &&
                    item.children.find((item) => item.name === "contact"))
            ) {
