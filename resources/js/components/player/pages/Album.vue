  ...
  <fixed-left v-if="album">
    ...
    <template v-slot:buttons>
      <div class="buttons">
        ...
        <div class="btn-container">
          <v-btn rounded small @click="likeAlbum" v-if="!isLiked">
            <v-icon small>$vuetify.icons.heart-outline</v-icon>
          </v-btn>
          <v-btn rounded small @click="likeAlbum" v-else>
    ...
    <template v-slot:main>
      <div class="songs-container" v-if="album.songs && album.songs.length">
        <List
          :isAlbum="true"
          :content="album.songs"
          class="song-list"
