<template>
    <div class="podcast-container elevate-page" v-if="episode">
        <div class="podcast__header">
            <div class="podcast__info">
                ...
                <div class="podcast__text">
                    <div class="info-badge">{{ $t("Podcast Episode") }}</div>
                    <div class="podcast__text__title">{{ episode.title }}</div>
                    <div class="" v-if="episode.podcast">
                        <router-link
                            class="router-link d-flex pt-2 pb-5 mb-3 align-center"
                            :to="{
                                name: 'podcast',
                                params: { id: episode.podcast.id },
                            }"
                        >
                            <div class="avatar mr-2">
                                <v-avatar size="35">
                                    <v-img :src="episode.podcast.cover"></v-img>
                                </v-avatar>
                            </div>
                    ...
                    <div
                        ...
                        v-html="episode.description || podcast.description"
                    ></div>
                </div>
            </div>
            <div
            ...
            <div class="podcast__actions">
                <div class="play-button">
                    <v-btn
                        ...
                        rounded
                        @click="pause"
                        v-if="isCurrentlyPlaying(episode)"
                    >
        ...
        <div class="podcast__body">
            <div
                class="podcast__episodes"
                v-if="
                    episode.podcast.episodes && episode.podcast.episodes.length
                "
            >
                ...
                <div class="episodes">
                    <v-card
                        class="episode"
                        v-for="ep in episode.podcast.episodes"
                        :key="ep.id"
                        @click="play(ep, true)"
                    >
                                ...
                                <div class="infos">
                                    ...
                                    <div class="times">
                                        <div class="created_at">
                                            {{
                                                formatEpisodeDate(ep.created_at)
                                            }}
                                        </div>
                                        <div class="duration">
                                            {{
    ...
    <empty-page
        v-else-if="!episode && errorStatus == 404"
...
export default {
    ...
    created() {
        axios
            ...
            .then((res1) => {
                var episode = res1.data;
                // fetch other episodes
                axios
                    .get("/api/podcast/" + episode.podcast.id)
                    .then((res) => {
